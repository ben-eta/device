...
PRODUCT_COPY_FILES +=	\
	...
	device/fsl/common/input/Vendor_0dfc_Product_0001.idc:system/usr/idc/Vendor_0dfc_Product_0001.idc \
	...
	device/fsl/common/input/eGTouch/eGalaxTouch_VirtualDevice.idc:system/usr/idc/eGalaxTouch_VirtualDevice.idc \
	device/fsl/common/input/eGTouch/eGTouchD:system/bin/eGTouchD \
	...
	device/fsl/imx6/etc/ota.conf:system/xb/ota.conf \
	device/fsl/imx6/etc/ota.conf:system/preinstall/notdel \
        device/fsl/sabresd_6dq/preinstall.sh:system/bin/preinstall.sh \
	device/fsl/sabresd_6dq/rtl8168.sh:system/bin/rtl8168.sh \
	device/fsl/imx6/etc/su_init.sh:system/etc/su_init.sh \
	device/fsl/imx6/etc/uptmx6.sh:system/bin/uptmx6.sh \
