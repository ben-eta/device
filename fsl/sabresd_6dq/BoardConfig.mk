...
TARGET_RECOVERY_FSTAB = device/fsl/sabresd_6dq/fstab_recovery.freescale
# build for ext4
PRODUCT_COPY_FILES +=	\
...
TARGET_KERNEL_MODULES := \
    kernel_imx/drivers/net/wireless/rtl8189es/8189es.ko:system/lib/modules/8189es.ko \
    kernel_imx/drivers/net/realtek-8111e-new/r8168.ko:system/lib/modules/r8168.ko
...
BOARD_KERNEL_CMDLINE := console=ttymxc0,115200 init=/init video=mxcfb0:dev=hdmi,1024x768M@60,bpp=32,if=RGB24 video=mxcfb1:off video=mxcfb2:off video=mxcfb3:off fbmem=18M fb0base=0x27b00000 vmalloc=400M androidboot.console=ttymxc0 androidboot.hardware=freescale
